...
@RestController
@RequestMapping("/api/micro-itinerary-cards")
public class MicroItineraryCardController {

    private final CardRepository cardRepository;

    public MicroItineraryCardController(CardRepository cardRepository) {
        this.cardRepository = cardRepository;
    }

    @GetMapping
    public ResponseEntity<List<Map<String, Object>>> getMicroItineraryCards() {
    ...
    public ResponseEntity<Card> createMicroItineraryCard(
